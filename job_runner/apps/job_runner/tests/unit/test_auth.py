...
#     """
#     @patch('job_runner.apps.job_runner.auth.Server')
#     def test_validate_hmac_valid_api_key(self, Server):
#         """
...
#         api_user = Server.objects.get.return_value
#         api_user.private_key = 'foobar'

#         self.assertTrue(validate_hmac(request))

#     @patch('job_runner.apps.job_runner.auth.Server')
#     def test_validate_hmac_invalid_api_key(self, Server):
#         """
