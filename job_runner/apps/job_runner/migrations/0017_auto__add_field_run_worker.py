...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Run.worker'
        db.add_column('job_runner_run', 'worker',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job_runner.Worker'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Run.worker'
        db.delete_column('job_runner_run', 'worker_id')
