...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WorkerPool', fields ['title']
        db.create_index('job_runner_workerpool', ['title'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'WorkerPool', fields ['title']
        db.delete_index('job_runner_workerpool', ['title'])
