...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.enqueue_is_enabled'
        db.add_column('job_runner_worker', 'enqueue_is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'Project.enqueue_is_enabled'
        db.add_column('job_runner_project', 'enqueue_is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'JobTemplate.enqueue_is_enabled'
        db.add_column('job_runner_jobtemplate', 'enqueue_is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.enqueue_is_enabled'
        db.delete_column('job_runner_worker', 'enqueue_is_enabled')

        # Deleting field 'Project.enqueue_is_enabled'
        db.delete_column('job_runner_project', 'enqueue_is_enabled')

        # Deleting field 'JobTemplate.enqueue_is_enabled'
        db.delete_column('job_runner_jobtemplate', 'enqueue_is_enabled')
