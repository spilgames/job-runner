...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('job_runner', ['KillRequest'])

        # Adding field 'Run.pid'
        db.add_column('job_runner_run', 'pid',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'KillRequest'
        db.delete_table('job_runner_killrequest')

        # Deleting field 'Run.pid'
        db.delete_column('job_runner_run', 'pid')
