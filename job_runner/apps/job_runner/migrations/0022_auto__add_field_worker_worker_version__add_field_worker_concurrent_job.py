...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.worker_version'
        db.add_column('job_runner_worker', 'worker_version',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Worker.concurrent_jobs'
        db.add_column('job_runner_worker', 'concurrent_jobs',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.worker_version'
        db.delete_column('job_runner_worker', 'worker_version')

        # Deleting field 'Worker.concurrent_jobs'
        db.delete_column('job_runner_worker', 'concurrent_jobs')
    ...
    models = {
        ...
        'job_runner.worker': {
            ...
            'concurrent_jobs': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'enqueue_is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'worker_version': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
